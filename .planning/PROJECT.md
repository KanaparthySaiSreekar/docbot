...
| React for dashboard frontend | Modern component-based UI, rich ecosystem for calendar/form components, good developer experience. Use React frontend skill during Phase 4 implementation. | — Pending |
